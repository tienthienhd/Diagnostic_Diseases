...
class DiseasePredict:
    ...
    def load_model(self):
        with open('C:/Users/nguye/Desktop/20172/20172-HeCoSoTriThuc/ProjectDocterAI/Symptoms.txt') as f:
            for line in f:
                self.symptoms.append(line.strip())
                
        self.classifier = load_model('C:/Users/nguye/Desktop/20172/20172-HeCoSoTriThuc/ProjectDocterAI/neuralnetwork2.h5')
        self.standarded = 1
        self.labelencoder_Y.classes_ = np.load('C:/Users/nguye/Desktop/20172/20172-HeCoSoTriThuc/ProjectDocterAI/labelencoder_y.npy')
