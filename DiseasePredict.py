...
class DiseasePredict:
    ...
    def load_model(self):
        with open('E:\\Code\\term6\\knowlegde_base_system\\doctorAI4\\Symptoms.txt') as f:
            for line in f:
                self.symptoms.append(line.strip())
                
        self.classifier = load_model('E:\\Code\\term6\\knowlegde_base_system\\doctorAI4\\neuralnetwork2.h5')
        self.standarded = 1
        self.labelencoder_Y.classes_ = np.load('E:\\Code\\term6\\knowlegde_base_system\\doctorAI4\\labelencoder_y.npy')
